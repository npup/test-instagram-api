...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _run2.default)(_config2.default); // conf
...
/***/ function(module, exports) {
	...
	exports.default = {
	  // Sample app data for the Instagram API, register at https://instagram.com/developer/
	  "clientId": "00e45e0a63c349069a6ca0ff6c916fe0",
	  "callback": "http://envall.se/test-tags/"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".slanted {\n  position: relative;\n  padding: .5em 1em; }\n  .slanted:before {\n    content: \" \";\n    line-height: 0;\n    z-index: -1;\n    -webkit-transform: skew(-22.7deg, 0);\n    -ms-transform: skewX(-22.7deg) skewY(0);\n    transform: skew(-22.7deg, 0);\n    -webkit-transform: skewX(0) translateX(-22.7deg);\n    -ms-transform: skewX(0) translateX(-22.7deg);\n    transform: skewX(0) translateX(-22.7deg);\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    right: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    -webkit-backface-visibility: hidden;\n    backface-visibility: hidden; }\n\n/**********************\n* colors\n**********************/\nhtml, html * {\n  box-sizing: border-box; }\n\nbody {\n  margin: 0;\n  background-color: #142433; }\n\nul {\n  list-style-type: none; }\n\na {\n  color: inherit; }\n  a:link, a:visited, a:hover, a:active {\n    text-decoration: underline; }\n  a.active {\n    text-decoration: none;\n    font-weight: bold; }\n    a.active.slanted::before {\n      box-shadow: 0.2em 0.2em 0.5em #f8f8f8; }\n\n#app {\n  max-width: 600px;\n  margin: 0 auto;\n  font-family: Verdana, Arial, Sans-serif;\n  padding: 1em;\n  color: #ededed; }\n\nh1 {\n  color: #11509f;\n  text-align: center;\n  width: 70%;\n  margin: 0 auto; }\n  h1.slanted:before {\n    background-color: #ffdd00; }\n\nh2 {\n  text-indent: .5em; }\n\nul.nav {\n  height: 1em;\n  padding-left: 0;\n  margin: 2em auto 3em;\n  width: 90%;\n  color: #f8f8f8; }\n  ul.nav li {\n    float: left;\n    width: 33.3%;\n    text-align: center; }\n\nli:nth-child(1) .slanted:before {\n  background-color: #149044; }\n\nli:nth-child(2) .slanted:before {\n  background-color: #ed741e; }\n\nli:nth-child(3) .slanted:before {\n  background-color: #11509f; }\n\np {\n  padding: 0 .25em;\n  line-height: 1.6em; }\n  p:first-of-type {\n    text-indent: 1em; }\n\nul.posts {\n  padding-left: 0;\n  color: #142433; }\n  ul.posts li {\n    padding: .5em;\n    box-shadow: 0.2em 0.2em 0.3em #eee;\n    margin: 0 auto 1em;\n    background-color: #e0e0e0;\n    border-radius: .2em;\n    max-width: 95%; }\n  ul.posts .ts {\n    font-size: .7em; }\n  ul.posts img {\n    display: block;\n    margin-top: .5em; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadMedia = __webpack_require__(229);

	var _loadMedia2 = _interopRequireDefault(_loadMedia);
	...
	var renderApp = function renderApp() {
	  var PostsWrapper = _react2.default.createClass({
	    displayName: "PostsWrapper",
	    render: function render() {
	      return _react2.default.createElement(_Posts2.default, { load: load, params: this.props.params });
	    }
	  });
	  _reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _reactRouter.Route,
	        { path: "/tags", component: PostsWrapper },
	        _react2.default.createElement(_reactRouter.Route, { path: "/tags/:tagName", component: _Post2.default })
	      ),
	...
	var load = null,
	    token = null;
	var bootstrappedLoader = function bootstrappedLoader(config) {
	  return function (tagName, callback) {
	    if (!token) {
	      token = (0, _auth.checkToken)();
	    }
	    if (!token) {
	      (0, _storage.storeTagName)(tagName);
	      return (0, _auth.requestToken)(config);
	    }
	    // replace media loader with configured loader, and use it
	    load = (0, _loadMedia2.default)(token);
	...
	exports.default = function (config) {
	  ...
	  var tagName = (0, _storage.checkTagName)();
	  if (tagName) {
	    (0, _storage.removeTagName)();
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _NavLink2.default,
	            { className: "slanted", to: "/tags/trav" },
	            "Trav"
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _NavLink2.default,
	            { className: "slanted", to: "/tags/galopp" },
	            "Galopp"
	          )
	        ),
	        _react2.default.createElement(
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "p",
	        null,
	        "Man kan här se en del bilder taggade på ",
	        _react2.default.createElement(
	          "a",
	          { href: "//instagram.com" },
	          "Instagram"
	        ),
	        ". För att anropen skall lyckas krävs en ",
	        _react2.default.createElement(
	          "code",
	          null,
	          "access token"
	        ),
	        " som fås genom att (om det behövs) ",
	        _react2.default.createElement(
	          "em",
	          null,
	          "en gång"
	        ),
	        " göra en inloggning i ",
	        _react2.default.createElement(
	          "a",
	          { href: "//instagram.com" },
	          "Instagram"
	        ),
	        ", varefter man kommer tillbaka hit och kan välja tagg obehindrat."
	      ),
	      _react2.default.createElement(
	        "p",
	        null,
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "https://www.instagram.com/explore/tags/" + tagName + "/" },
	          "#",
	          tagName
	        ),
	        " nyligen taggade bilder"
	      ),
	      _react2.default.createElement(
	        "ul",
	        { className: "posts" },
	        this.state.posts.map(function (post, idx) {
	          return _react2.default.createElement(_Post2.default, { key: "post-" + idx, data: post });
	        })
	      )
	    );
	  }
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "a",
	        { className: "author", href: "https://instagram.com/" + this.props.data.username },
	        "@",
	      ...
	      _react2.default.createElement(
	        "span",
	        { className: "ts", "data-ts": this.props.data.ts },
	        fmtDate(this.props.data.ts)
	      ),
	      _react2.default.createElement("img", { src: this.props.data.img.thumb }),
	      _react2.default.createElement(
	        "p",
	        { className: "caption" },
...
/***/ function(module, exports) {
	...
	var checkToken = function checkToken() {
	  var value = location.hash.split(/^#access_token=/)[1];
	  return value ? value : void 0;
	};

	var requestToken = function requestToken(config) {
	  var url = "https://www.instagram.com/oauth/authorize/?client_id=" + config.clientId + "&redirect_uri=" + config.callback + "&response_type=token&scope=public_content";
...
/***/ function(module, exports) {
	...
	var shim = {};
	var win = global,
	    has = "localStorage" in win,
	    api = {
	  "get": has ? function (key) {
	    return win.localStorage.getItem(key);
	  } : function (key) {
	    return shim[key];
	  } // dummy impl
	  , "set": has ? function (key, value) {
	    return win.localStorage.setItem(key, value);
	  } : function (key, value) {
	    shim[key] = String(value);
	  } // dummy impl
	  , "remove": has ? function (key) {
	...
	var storeTagName = function storeTagName(tagName) {
	  api.set("tagName", tagName);
	  return tagName;
	};
	var checkTagName = function checkTagName() {
	  return api.get("tagName");
	};
	var removeTagName = function removeTagName() {
	  api.remove("tagName");
	};

	exports.storeTagName = storeTagName;
	exports.checkTagName = checkTagName;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonp = __webpack_require__(230);

	var _jsonp2 = _interopRequireDefault(_jsonp);

	var _massage = __webpack_require__(231);
	...
	exports.default = function (token) {
	  return function (tag, callback) {
	    ...
	    (0, _jsonp2.default)(url, function (response) {
	      var posts = response.data.reduce(function (acc, post) {
	        post && acc.push((0, _massage2.default)(post));
	        return acc;
	      }, []);
	      callback(posts);
	    }, "callback");
